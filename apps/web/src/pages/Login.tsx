      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-card p-8 sm:p-10 animate-scale-in">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-2xl shadow-card mb-4">
            ...
            <p className="text-gray-600">
              {t('loginSubtitle') || 'Welcome back to Belgrade Mama'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-50 border-2 border-transparent focus:border-primary-400 focus:bg-white rounded-2xl text-gray-800 placeholder-gray-400 transition-all duration-200 outline-none font-medium"
            ...
            <button
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 rounded-2xl text-white font-bold text-lg shadow-card hover:shadow-card-hover transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              disabled={loading}
            >
              {loading ? (
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          {t('loginInfo') || 'Secure login powered by Belgrade Mama'}
        </p>
      </div>
    </div>
  );
